...
age_csv = './csv_files/one_sentence_categorized_age_data.csv'
gender_csv = './csv_files/emotion20_veriseti.csv'
emotion_csv = './csv_files/All_label_emotion20_veriseti.csv'
