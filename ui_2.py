...
class SesTahminiArayuzu:
    def __init__(self, ana_pencere):
        ...
        button_conf = {'width': 150, 'height': 50, 'bg': "#f0f0f0"}
        # row0---------------------------------------
        ...
        self.ses_kaydi_dugmesi = ImageRoundedButton(self.kontrol_frame, "./icons/play.png", text="Ses Kaydına Başla",command=self.ses_kaydet, **button_conf)
