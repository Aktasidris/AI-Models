...
# Veriyi yükleyin
data = pd.read_csv('csv_files/All_label_emotion20_veriseti.csv')

# Çıkarılacak sütunlar
columns_to_drop = ['Energy', 'Spectral_Centroid', 'Spectral_Bandwidth', 'Spectral_Rolloff',
                   'Zero_Crossing_Rate', 'Chroma_STFT', 'Gender']
...
for i in range(3):  # 5 iterasyonla sınırlı
...
model_filename = f'emotion2345_{best_accuracy:.2f}.pkl'
...
'''
Best params for iteration 12: {'max_depth': 10, 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 500}
Accuracy for iteration 12: 0.46
'''